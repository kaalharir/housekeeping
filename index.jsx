 ...
 * 
 * Create an App component in a separate App.jsx file which is a sibling to the index.jsx file.
 ...
 *      - At this point you should have your "Navbar goes here" etc. showing up in the
 * mini-browser.
 * Go to Google fonts and get the "Inter" font with weights 400, 600, and 700.
 * Put the '<links />' to those fonts ABOVE the style.css link in index.html. 
 * You may need to do some extra research to figure out how this works if you 
